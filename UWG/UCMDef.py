...
class UCMDef(object):
    ...
    def __init__(self,bldHeight,bldDensity,verToHor,HighVegCover,sensAnthrop,latAnthrop,
        initialTemp,initialHum,initialWind,parameter,r_glaze,SHGC,alb_wall,road,alb_road,vegCover,lambdap):
        ...
        self.HighVegCover = HighVegCover                                   # horizontal tree density (footprint)
        ...
        self.roadShad = min(HighVegCover/(1-bldDensity),1)                 # fraction of road not building shadowed
        ...
        # Calculate urban displacement length, Eq. 4.19, Krayenhoff 2014, PhD thesis
        self.l_disp = self.bldHeight * (lambdap ** (0.15))
